...
Два основных домена - взаимодействие с устройствами в доме (можно еще разделить на датчики температуры и систему отопления) и взаимодействие с пользователем (отображение информации, обработка запросов на вкл/выкл обогрева).
...
[Текущее решение](https://github.com/bigboom64/architecture-warmhouse/blob/warmhouse/monolith/diagram.png)
